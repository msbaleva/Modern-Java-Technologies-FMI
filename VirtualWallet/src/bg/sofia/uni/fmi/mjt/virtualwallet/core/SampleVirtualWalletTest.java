...
public class SampleVirtualWalletTest {
	...
	@Test
	public void testGoldenCard() {
		assertTrue(wallet.registerCard(goldenCard));
		assertTrue(wallet.feed(goldenCard, 100));
		System.out.println(goldenCard.getAmount());
		PaymentInfo paymentInfo = new PaymentInfo("taka", "tuk", 50);
		wallet.executePayment(goldenCard, paymentInfo);
		System.out.println(goldenCard.getAmount());
	}
